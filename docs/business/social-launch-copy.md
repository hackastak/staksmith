...
- npm installs (`staksmith`, `ecc-agentshield`)
- GitHub App installs
...
In staksmith we turned this into production checks via:
- /harness-audit
- /quality-gate
...
```text
We shipped staksmith v1.8.0 with one objective: improve agent harness performance in production.
