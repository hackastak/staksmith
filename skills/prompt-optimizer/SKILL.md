...
Analyze a draft prompt, critique it, match it to staksmith ecosystem components,
...
- User says "how should I use staksmith for..."
...
- User is asking about staksmith configuration (use `configure-staksmith` instead)
...
### Phase 3: staksmith Component Matching

Map intent + scope + tech stack (from Phase 0) to specific staksmith components.
...
### Section 2: Recommended staksmith Components
...
A compact version for experienced staksmith users. Vary by intent type:
...
- "Optimize this prompt for staksmith"
- "Rewrite this prompt so Claude Code uses the right commands"
- "帮我优化这个指令"
- "How should I prompt staksmith for this task?"
...
|-----------|------------------|
| `configure-staksmith` | User hasn't set up staksmith yet |
