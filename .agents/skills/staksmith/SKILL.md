...
Optional companion instincts live at `.Codex/homunculus/instincts/inherited/staksmith-instincts.yaml` for teams using `continuous-learning-v2`.

## When to Use

Activate this skill when the task touches one or more of these areas:
- cross-platform parity across Codex, Cursor, Codex, and OpenCode
...
Do not assume every `.Codex/` artifact needs a cross-platform copy. Only mirror files that are part of the shipped multi-platform surface.
