...
const DEFAULT_INSTALL_CONFIG = 'staksmith-install.json';
const CONFIG_SCHEMA_PATH = path.join(__dirname, '..', '..', '..', 'schemas', 'staksmith-install-config.schema.json');
...
function getValidator() {
  ...
  const schema = readJson(CONFIG_SCHEMA_PATH, 'staksmith-install-config.schema.json');
