# The Longform Guide to staksmith

![Header: The Longform Guide to staksmith](./assets/images/longform/01-header.png)

---

> **Prerequisite**: This guide builds on [The Shorthand Guide to staksmith](./the-shortform-guide.md). Read that first if you haven't set up skills, hooks, subagents, MCPs, and plugins.
...
Everything covered in the shorthand and longform guides is available on GitHub: `github.com/hackastak/staksmith`
...
*Example of session storage -> <https://github.com/hackastak/staksmith/tree/main/examples/sessions>*
...
I've built these hooks and they're in the repo at `github.com/hackastak/staksmith/tree/main/hooks/memory-persistence`
...
I've built a continuous learning skill that does this: `github.com/hackastak/staksmith/tree/main/skills/continuous-learning`
...
*Everything covered in both guides is available on GitHub at [staksmith](https://github.com/hackastak/staksmith)*
