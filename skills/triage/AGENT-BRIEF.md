...
Where the brief lands depends on the tracker backend: a comment on the GitHub issue or PR, or an append under the `## Comments` heading of the vault or local ticket file. The content is identical either way.
