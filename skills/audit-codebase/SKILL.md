...
| Accessibility | `general-purpose` (briefed with the `a11y-review` dimensions) | only if a frontend/UI layer is detected; semantic structure, keyboard/focus, ARIA, names/labels, contrast, live regions |
