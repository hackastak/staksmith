...
Inspect staksmith install-state files for the current home/project context.
`);
...
function printHuman(records) {
  if (records.length === 0) {
    console.log('No staksmith install-state files found for the current home/project context.');
    return;
  }

  console.log('Installed staksmith targets:\n');
