...
class SkillCreateOutput {
  ...
  header() {
    ...
    console.log(chalk.bold(chalk.magenta('║')) + chalk.bold('  🔮 staksmith Skill Creator                                    ') + chalk.bold(chalk.magenta('║')));
...
`));
  ...
  footer() {
    ...
    console.log(chalk.dim(`  Powered by staksmith • staksmith.tools`));
