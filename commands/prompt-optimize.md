---
description: Analyze a draft prompt and output an optimized, staksmith-enriched version ready to paste and run. Does NOT execute the task — outputs advisory analysis only.
---

# /prompt-optimize

Analyze and optimize the following prompt for maximum staksmith leverage.
...
3. **staksmith Component Matching** — Map to specific skills, commands, agents, and model tier
...
- Present diagnosis, recommended staksmith components, and an optimized prompt using the Output Format from the prompt-optimizer skill
